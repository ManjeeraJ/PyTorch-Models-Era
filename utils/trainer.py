...
"""
1. Commented out return block
2. Train_acc is recorded at batch and epoch level; can use whichever one
3. Train loss is appended and not added for every batch; for more granularity
"""
class Trainer:
